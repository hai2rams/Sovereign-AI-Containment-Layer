 ...
 *
 * Ported from prototype `prototype/t3-validated` — session bootstrap only.
 * M0 does not perform production contract writes from this module.
 *
...
/** Clears the cached session (useful in tests or after credential rotation). */
